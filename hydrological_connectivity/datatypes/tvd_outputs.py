...
class TvdOutputs():
    """Location of files for tvd processing"""

    def __init__(self, short_description, flood_extent_path, dem_path, hydraulic_model: HydraulicModel, simulation_timespan, coords, region_of_interest_albers, region_of_interest_wgs84, segment_index, output_path):
